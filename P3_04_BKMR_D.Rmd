...
singvar_trnkfat2
1.1765492 - 1.96*0.5923510
1.1765492 + 1.96*0.5923510

0.6816172 - 1.96*0.5253724	
0.6816172 + 1.96*0.5253724	

-0.7970705 - 1.96*0.3626802	
-0.7970705 + 1.96*0.3626802	

-0.7822324 - 1.96*0.3345458	
-0.7822324 + 1.96*0.3345458	

-0.3113605 - 1.96*0.3877612	
-0.3113605 + 1.96*0.3877612	

0.6128832 - 1.96*0.4051413
0.6128832 + 1.96*0.4051413
...
2.6766143 - 1.96*0.9938747
2.6766143 + 1.96*0.9938747

0.4540515 - 1.96*0.8364523	
0.4540515 + 1.96*0.8364523	

-1.4234082 - 1.96*0.5969925	
-1.4234082 + 1.96*0.5969925	

-1.4366559 - 1.96*0.5487128	
-1.4366559 + 1.96*0.5487128	

-0.2106079 - 1.96*0.6206572	
-0.2106079 + 1.96*0.6206572	

0.9425795 - 1.96*0.6558698	
0.9425795 + 1.96*0.6558698	
...
p_singvar_trnkfat2 <- ggplot(singvar_trnkfat2, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) + 
  theme_bw() + theme(text = element_text(size = 35, color = "black")) + theme(axis.title.y = element_blank()) +
  scale_x_discrete(limits = c("EtFOSAA", "MeFOSAA", "PFHxS", "PFNA", "PFOA", "PFOS")) +
