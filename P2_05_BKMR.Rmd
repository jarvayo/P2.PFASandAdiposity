...
Weight <- PFAS_AD$WEIGHT_mdxa17
Waist <- PFAS_AD$mom_waist_ma17
Fat <- PFAS$mom_bodyfat_ma17

##### CREAT THE COVARIATE MATRIX
cov <- as.matrix(cbind(PFAS_AD$age_enroll, PFAS_AD$race2_mom_epi_epia_d, PFAS_AD$bmi_cat, PFAS_AD$coll_grad, 
                       PFAS_AD$smokpreg_final_d, PFAS_AD$parity, PFAS_AD$married_cohab))

##### SET THE SEED
set.seed(127)

##### CREATE KNOTS
knots <- fields::cover.design(lnmixture_ad_z, nd = 40)$design
...
##### BUILD BKMR MODELS 
# VAT
mod.vat <- kmbayes(y=PFAS_AD$LNVAT_AREA, Z=lnmixture_ad_z, X=cov, iter=25000, family = "gaussian", 
