...
cov <- as.matrix(cbind(PFAS_A$age_enroll, PFAS_A$race, PFAS_A$bmi_cat, PFAS_A$edu, 
...
# CREATE KNOTS
knots <- fields::cover.design(lnmixture_a_z, nd = 50)$design
...
# CREAT THE COVARIATE MATRIX
cov <- as.matrix(cbind(PFAS_AD$age_enroll, PFAS_AD$race, PFAS_AD$bmi_cat, PFAS_AD$edu, 
