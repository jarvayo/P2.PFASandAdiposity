...
uni_ad_vata <- ggplot(univar_ad_vata, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) + facet_wrap(~ variable) + 
  geom_smooth(stat = "identity") + xlab("Serum ln-transformed concentration") + ylab("Difference in VAT area (cm^3)")
...
uni_ad_vatv <- ggplot(univar_ad_vatv, aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) + facet_wrap(~ variable) + 
  geom_smooth(stat = "identity") + xlab("Serum ln-transformed concentration") + ylab("Difference in VAT volume (cm^3)")

uni1_ad_vatv <- ggplot(univar_ad_vatv[1:50,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-PFOS concentration") + ylab("Difference in VAT volume (cm^3)")

uni2_ad_vatv <- ggplot(univar_ad_vatv[51:100,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-PFOA concentration") + ylab("Difference in VAT volume (cm^3)")

uni3_ad_vatv <- ggplot(univar_ad_vatv[101:150,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-PFNA concentration") + ylab("Difference in VAT volume (cm^3)")

uni4_ad_vatv <- ggplot(univar_ad_vatv[151:200,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-PFHxS concentration") + ylab("Difference in VAT volume (cm^3)")

uni5_ad_vatv <- ggplot(univar_ad_vatv[201:250,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-MeFOSSA concentration") + ylab("Difference in VAT volume (cm^3)")

uni6_ad_vatv <- ggplot(univar_ad_vatv[251:300,], aes(z, est, ymin = est - 1.96*se, ymax = est + 1.96*se)) +
  geom_smooth(stat = "identity", colour='black') + theme_classic() +
  xlab("Scaled ln-EtFOSSA concentration") + ylab("Difference in VAT volume (cm^3)")
...
# VAT AREA
bivar_ad_vata <- PredictorResponseBivar(fit = m_ad_vata, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# SAAT AREA
bivar_ad_saata <- PredictorResponseBivar(fit = m_ad_saata, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# TAAT AREA
bivar_ad_taata <- PredictorResponseBivar(fit = m_ad_taata, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# VAT MASS
bivar_ad_vatm <- PredictorResponseBivar(fit = m_ad_vatm, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# SAAT MASS
bivar_ad_saatm <- PredictorResponseBivar(fit = m_ad_saatm, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# TAAT MASS
bivar_ad_taatm <- PredictorResponseBivar(fit = m_ad_taatm, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# VAT VOLUME
bivar_ad_vatv <- PredictorResponseBivar(fit = m_ad_vatv, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# SAAT VOLUME
bivar_ad_saatv <- PredictorResponseBivar(fit = m_ad_saatv, min.plot.dist = 1, sel = sel_final, method = "approx")
...
# TAAT VOLUME
bivar_ad_taatv <- PredictorResponseBivar(fit = m_ad_taatv, min.plot.dist = 1, sel = sel_final, method = "approx")
...
p_interact_ad_vata <- ggplot(interact_ad_vata, aes(z1, est)) +
  ...
  ylab ("Difference in VAT area (cm^3)") +
...
p_interact_ad_saata <- ggplot(interact_ad_saata, aes(z1, est)) +
  ...
  facet_grid(variable2 ~ variable1) +
  xlab ("Ln-transformed PFAS 1") +
  ylab ("Difference in SAAT area (cm^3)") +
  ggtitle("h(PFAS 1 | Quantiles of PFAS 2)") 
p_interact_ad_saata
...
p_interact_ad_taata <- ggplot(interact_ad_taata, aes(z1, est)) +
  ...
  facet_grid(variable2 ~ variable1) +
  xlab ("Ln-transformed PFAS 1") +
  ylab ("Difference in TAAT area (cm^3)") +
  ggtitle("h(PFAS 1 | Quantiles of PFAS 2)") 
p_interact_ad_taata
...
# VAT AREA
overall_ad_vata <- OverallRiskSummaries(fit = m_ad_vata, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_vata <- SingVarRiskSummaries(fit = m_ad_vata, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_vata <- SingVarIntSummaries(fit = m_ad_vata, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# SAAT AREA
overall_ad_saata <- OverallRiskSummaries(fit = m_ad_saata, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_saata <- SingVarRiskSummaries(fit = m_ad_saata, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_saata <- SingVarIntSummaries(fit = m_ad_saata, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# TAAT AREA
overall_ad_taata <- OverallRiskSummaries(fit = m_ad_taata, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_taata <- SingVarRiskSummaries(fit = m_ad_taata, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_taata <- SingVarIntSummaries(fit = m_ad_taata, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# VAT MASS
overall_ad_vatm <- OverallRiskSummaries(fit = m_ad_vatm, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_vatm <- SingVarRiskSummaries(fit = m_ad_vatm, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_vatm <- SingVarIntSummaries(fit = m_ad_vatm, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# SAAT MASS
overall_ad_saatm <- OverallRiskSummaries(fit = m_ad_saatm, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_saatm <- SingVarRiskSummaries(fit = m_ad_saatm, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_saatm <- SingVarIntSummaries(fit = m_ad_saatm, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# TAAT MASS
overall_ad_taatm <- OverallRiskSummaries(fit = m_ad_taatm, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_taatm <- SingVarRiskSummaries(fit = m_ad_taatm, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_taatm <- SingVarIntSummaries(fit = m_ad_taatm, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# VAT VOLUME
overall_ad_vatv <- OverallRiskSummaries(fit = m_ad_vatv, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_vatv <- SingVarRiskSummaries(fit = m_ad_vatv, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_vatv <- SingVarIntSummaries(fit = m_ad_vatv, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# SAAT VOLUME
overall_ad_saatv <- OverallRiskSummaries(fit = m_ad_saatv, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_saatv <- SingVarRiskSummaries(fit = m_ad_saatv, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_saatv <- SingVarIntSummaries(fit = m_ad_saatv, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)

# TAAT VOLUME
overall_ad_taatv <- OverallRiskSummaries(fit = m_ad_taatv, q.fixed = 0.50, sel = sel_final,
                                               method = "approx", qs = seq(0.25, 0.75, by = 0.05))
singvar_ad_taatv <- SingVarRiskSummaries(fit = m_ad_taatv, qs.diff = c(0.25, 0.75),
                                            q.fixed = c(0.25, 0.50, 0.75),sel=sel_final, method = "approx")
overall_interact_ad_taatv <- SingVarIntSummaries(fit = m_ad_taatv, qs.diff = c(0.25, 0.75),
                                       qs.fixed = c(0.25, 0.75),sel=sel_final)
...
p_overall_ad_vata <- ggplot(overall_ad_vata, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               ...
               geom_pointrange() +
               scale_y_continuous(name = "Change in VAT area (cm^3)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
...
p_singvar_ad_vata <- ggplot(singvar_ad_vata, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in VAT area (cm^3)")
p_singvar_ad_vata
...
p_overall_ad_saata <- ggplot(overall_ad_saata, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               geom_hline(yintercept = 00, linetype = "dashed", color = "dark blue") +
               geom_pointrange() +
               scale_y_continuous(name = "Change in SAAT area (cm^3)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
               axis.text.x = element_text(size = 11),
               axis.text.y = element_text(size = 11),
...
p_singvar_ad_saata <- ggplot(singvar_ad_saata, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in SAAT area (cm^3)")
p_singvar_ad_saata
...
p_overall_ad_taata <- ggplot(overall_ad_taata, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               geom_hline(yintercept = 00, linetype = "dashed", color = "dark blue") +
               geom_pointrange() +
               scale_y_continuous(name = "Change in TAAT area (cm^3)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
               axis.text.x = element_text(size = 11),
               axis.text.y = element_text(size = 11),
...
p_singvar_ad_taata <- ggplot(singvar_ad_taata, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in TAAT area (cm^3)")
p_singvar_ad_taata
...
p_singvar_ad_vatm <- ggplot(singvar_ad_vatm, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in VAT mass (kg/m^2)")
p_singvar_ad_vatm
...
p_singvar_ad_saatm <- ggplot(singvar_ad_saatm, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in SAAT mass (kg/m^2)")
p_singvar_ad_saatm
...
p_singvar_ad_taatm <- ggplot(singvar_ad_taatm, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in TAAT mass (kg/m^2)")
p_singvar_ad_taatm
...
p_overall_ad_vatv <- ggplot(overall_ad_vatv, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               geom_hline(yintercept = 00, linetype = "dashed", color = "dark blue") +
               geom_pointrange() +
               scale_y_continuous(name = "Change in VAT volume (cm^#)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
               axis.text.x = element_text(size = 11),
               axis.text.y = element_text(size = 11),
...
p_singvar_ad_vatv <- ggplot(singvar_ad_vatv, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in VAT volume (cm^#)")
p_singvar_ad_vatv
...
p_overall_ad_saatv <- ggplot(overall_ad_saatv, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               geom_hline(yintercept = 00, linetype = "dashed", color = "dark blue") +
               geom_pointrange() +
               scale_y_continuous(name = "Change in SAAT volume (cm^#)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
               axis.text.x = element_text(size = 11),
               axis.text.y = element_text(size = 11),
...
p_singvar_ad_saatv <- ggplot(singvar_ad_saatv, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in SAAT volume (cm^#)")
p_singvar_ad_saatv
...
p_overall_ad_taatv <- ggplot(overall_ad_taatv, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) +
               geom_hline(yintercept = 00, linetype = "dashed", color = "dark blue") +
               geom_pointrange() +
               scale_y_continuous(name = "Change in TAAT volume (cm^#)")+
               xlab("PFAS quantile") +
               theme_classic()+ theme(
               axis.text.x = element_text(size = 11),
               axis.text.y = element_text(size = 11),
...
p_singvar_ad_taatv <- ggplot(singvar_ad_taatv, aes(variable, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd,
  ...
  geom_hline(aes(yintercept = 0), linetype = "dashed", color = "gray") +
  geom_pointrange(position = position_dodge(width = 0.75)) + coord_flip() +
  scale_x_discrete(name = "Ln-transformed PFAS concentration") + scale_y_continuous(name = "Change in TAAT volume (cm^#)")
p_singvar_ad_taatv
