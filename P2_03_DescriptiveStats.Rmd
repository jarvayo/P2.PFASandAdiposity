...
PFAS_AD$LN2PFOS <- log(PFAS_AD$PFOS, 2)
PFAS_AD$LN2PFOA <- log(PFAS_AD$PFOA, 2)
PFAS_AD$LN2PFNA2 <- log(PFAS_AD$PFNA2, 2)
PFAS_AD$LN2PFHxS <- log(PFAS_AD$PFHxS, 2)
PFAS_AD$LN2ME_PFOSA <- log(PFAS_AD$Me_PFOSA_AcOH2, 2)
PFAS_AD$LN2ET_PFOSA <- log(PFAS_AD$Et_PFOSA_AcOH, 2)
...
PFAS_AD$LNMUAC <- log(PFAS_AD$mom_muac_ma17)
...
hist(PFAS_AD$LN2PFOS)
hist(PFAS_AD$LN2PFOA)
hist(PFAS_AD$LN2PFNA2)
hist(PFAS_AD$LN2PFHxS)
hist(PFAS_AD$LN2ME_PFOSA)
hist(PFAS_AD$LN2ET_PFOSA)
...
ks.test(PFAS_A$mom_hip_ma17, 'pnorm')
...
ks.test(PFAS_AD$VAT_AREA_mdxa17, 'pnorm')
ks.test(PFAS_AD$SAT_AREA_mdxa17, 'pnorm')
ks.test(PFAS_AD$TAT_AREA_mdxa17, 'pnorm')
ks.test(PFAS_AD$VAT_MASS_mdxa17, 'pnorm')
ks.test(PFAS_AD$SAT_MASS_mdxa17, 'pnorm')
ks.test(PFAS_AD$TAT_MASS_mdxa17, 'pnorm')
ks.test(PFAS_AD$VAT_VOLUME_mdxa17, 'pnorm')
ks.test(PFAS_AD$SAT_VOLUME_mdxa17, 'pnorm')
ks.test(PFAS_AD$TAT_VOLUME_mdxa17, 'pnorm')
ks.test(PFAS_AD$LNVAT_AREA, 'pnorm')
ks.test(PFAS_AD$LNSAT_AREA, 'pnorm')
ks.test(PFAS_AD$LNTAT_AREA, 'pnorm')
ks.test(PFAS_AD$LNVAT_MASS, 'pnorm')
ks.test(PFAS_AD$LNSAT_MASS, 'pnorm')
ks.test(PFAS_AD$LNTAT_MASS, 'pnorm')
ks.test(PFAS_AD$LNVAT_VOLUME, 'pnorm')
ks.test(PFAS_AD$LNSAT_VOLUME, 'pnorm')
ks.test(PFAS_AD$LNTAT_VOLUME, 'pnorm')
...
OUTCOMES_A_corr <- PFAS_A[ , c("BMI", "Waist", "Hip", "MUAC", "FatPct", "FatMass", "Weight")]
...
colnames(PFAS_AD)[colnames(PFAS_AD) == "mom_muac_ma17"] <- "MUAC"
...
OUTCOMES_AD_corr <- PFAS_AD[ , c("VT area", "ST area", "TT area", "VT vol", "ST vol", 
                               ...
                               "Weight", "Waist", "Hip", "MUAC", "FatPct", "FatMass")]
