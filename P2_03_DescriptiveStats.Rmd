...
PFAS_A$LNME_FOSAA <- log(PFAS_A$Me_PFOSA_AcOH2)
PFAS_A$LNET_FOSAA <- log(PFAS_A$Et_PFOSA_AcOH)

PFAS_A$L2PFOS <- log(PFAS_A$PFOS, 2)
PFAS_A$L2PFOA <- log(PFAS_A$PFOA, 2)
PFAS_A$L2PFNA2 <- log(PFAS_A$PFNA2, 2)
PFAS_A$L2PFHxS <- log(PFAS_A$PFHxS, 2)
PFAS_A$L2ME_FOSAA <- log(PFAS_A$Me_PFOSA_AcOH2, 2)
PFAS_A$L2ET_FOSAA <- log(PFAS_A$Et_PFOSA_AcOH, 2)
...
PFAS_D$LNME_FOSAA <- log(PFAS_D$Me_PFOSA_AcOH2)
PFAS_D$LNET_FOSAA <- log(PFAS_D$Et_PFOSA_AcOH)

PFAS_D$L2PFOS <- log(PFAS_D$PFOS, 2)
PFAS_D$L2PFOA <- log(PFAS_D$PFOA, 2)
PFAS_D$L2PFNA2 <- log(PFAS_D$PFNA2, 2)
PFAS_D$L2PFHxS <- log(PFAS_D$PFHxS, 2)
PFAS_D$L2ME_FOSAA <- log(PFAS_D$Me_PFOSA_AcOH2, 2)
PFAS_D$L2ET_FOSAA <- log(PFAS_D$Et_PFOSA_AcOH, 2)
...
hist(PFAS_A$LNPFNA2)
hist(PFAS_A$LNPFHxS)
hist(PFAS_A$LNME_FOSAA)
hist(PFAS_A$LNET_FOSAA)
...
hist(PFAS_A$L2PFNA2)
hist(PFAS_A$L2PFHxS)
hist(PFAS_A$L2ME_FOSAA)
hist(PFAS_A$L2ET_FOSAA)
...
hist(PFAS_D$LNPFNA2)
hist(PFAS_D$LNPFHxS)
hist(PFAS_D$LNME_FOSAA)
hist(PFAS_D$LNET_FOSAA)
...
hist(PFAS_D$L2PFNA2)
hist(PFAS_D$L2PFHxS)
hist(PFAS_D$L2ME_FOSAA)
hist(PFAS_D$L2ET_FOSAA)
...
##### TABE 1
table1(~ age_enroll + age_fu + fu_time + race + bmi_cat + menar + edu + income + 
         parity + smoke + married, data = PFAS_A, overall = "Total")
...
##### TABE 1
table1(~ age_enroll + age_fu + fu_time + race + bmi_cat + menar + edu + income + 
         parity + smoke + married, data = PFAS_D, overall = "Total")
...
##### TABE 1
table1(~ age_enroll + race + bmi_cat + edu + income + parity + menar +
...
OUTCOMES_A_corr <- PFAS_A[ , c("BMI", "Waist", "WHR", "MUAC", "FatMass", "FatPct")]
