...
colnames(PFAS_A)[colnames(PFAS_A) == "mom_bodyfat_ma17"] <- "Fat %"
colnames(PFAS_A)[colnames(PFAS_A) == "mom_fat_ma17"] <- "Fat mass"
colnames(PFAS_A)[colnames(PFAS_A) == "mom_weight_ma17"] <- "Weight"

##### OUTCOMES CORRELATION MATRIX
OUTCOMES_A_corr <- PFAS_A[ , c("BMI", "Waist", "Hip", "Fat %", "Fat mass", "Weight")]
...
colnames(PFAS_AD)[colnames(PFAS_AD) == "mom_bodyfat_ma17"] <- "Fat %"
colnames(PFAS_AD)[colnames(PFAS_AD) == "mom_fat_ma17"] <- "Fat mass"

##### OUTCOMES CORRELATION MATRIX
OUTCOMES_AD_corr <- PFAS_AD[ , c("VT area", "ST area", "TT area", "VT vol", "ST vol", 
                               "TT vol", "VT mass", "ST mass", "TT mass", "BMI", 
                               "Weight", "Waist", "Hip", "Fat %", "Fat mass")]
