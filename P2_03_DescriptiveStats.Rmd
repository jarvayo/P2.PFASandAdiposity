...
PFAS_AD <-read.csv("C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_BD_COMP.csv")
...
PFAS_AD$LNVAT_AREA <- log(PFAS_AD$VAT_MASS_mdxa17)
PFAS_AD$LNSAT_AREA <- log(PFAS_AD$SAT_MASS_mdxa17)
PFAS_AD$LNTAT_AREA <- log(PFAS_AD$TAT_MASS_mdxa17)
PFAS_AD$LNVAT_AREA <- log(PFAS_AD$VAT_VOLUME_mdxa17)
PFAS_AD$LNSAT_AREA <- log(PFAS_AD$SAT_VOLUME_mdxa17)
PFAS_AD$LNTAT_AREA <- log(PFAS_AD$TAT_VOLUME_mdxa17)
...
PFAS_AD$LNWT <- log(PFAS_AD$mom_weight_ma17)
