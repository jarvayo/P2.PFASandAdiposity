...
modelsummary(wad.l2m.wt.sens1, fmt = 1,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"),
...
modelsummary(ad.l2m.waist, fmt = 1,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"),
...
modelsummary(wad.l2m.waist, fmt = 1,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"),
...
modelsummary(wad.l2m.waist.sens1, fmt = 1,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}",
                           "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"),
...
modelsummary(ad.l2m.trnkfat, fmt = 1, estimate = "{estimate}{stars}", 
...
modelsummary(wad.l2m.trnkfat, fmt = 1, estimate = "{estimate}{stars}", 
             statistic = c("SE: {std.error}", "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"), 
...
modelsummary(wad.l2m.trnkfat.sens1, fmt = 1, estimate = "{estimate}{stars}", 
             statistic = c("SE: {std.error}", "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"), 
...
modelsummary(ad.l2m.totfat, fmt = 1, estimate = "{estimate}{stars}", 
             statistic = c("SE: {std.error}", "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"), 
...
modelsummary(wad.l2m.totfat, fmt = 1, estimate = "{estimate}{stars}", 
             statistic = c("SE: {std.error}", "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"), 
...
modelsummary(wad.l2m.totfat.sens1, fmt = 1, estimate = "{estimate}{stars}", 
             statistic = c("SE: {std.error}", "95% CI: [{conf.low}, {conf.high}]",
                           "p = {p.value}"), 
