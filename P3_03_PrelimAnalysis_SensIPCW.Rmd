...
```{r message=FALSE, warning=FALSE}
##### LOAD DATASET
PFAS_IPW <-read.csv("C:/Users/jarva/Desktop/James-Todd Lab/P3.PFASandAdiposity/Data/PFAS_IPW_COMP.csv")
PFAS_A <-read.csv("C:/Users/jarva/Desktop/James-Todd Lab/P3.PFASandAdiposity/Data/PFAS_A.csv")
PFAS_D <-read.csv("C:/Users/jarva/Desktop/James-Todd Lab/P3.PFASandAdiposity/Data/PFAS_D.csv")
...
##### TABE 1
library("table1")
table1(~ age + menar + bmi + bmi_cat + race +  income + 
         parity + smoke + married + edu, 
