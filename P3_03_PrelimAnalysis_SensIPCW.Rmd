...
PFAS_A <- PFAS_A %>% relocate(aid, L2PFOS, L2PFOA, L2PFNA, L2PFHxS, L2MeFOSAA, L2EtFOSAA,
                              PFOS_w, PFOA_w, PFNA_w, PFHxS_w, MeFOSAA_w, EtFOSAA_w, everything()) 
PFAS_D <- PFAS_D %>% relocate(aid, L2PFOS, L2PFOA, L2PFNA, L2PFHxS, L2MeFOSAA, L2EtFOSAA,
                              PFOS_w, PFOA_w, PFNA_w, PFHxS_w, MeFOSAA_w, EtFOSAA_w, everything()) 
...
m_WT <- glm(PFAS_A$Weight ~ PFAS_A[[i]] + PFAS_A$age + PFAS_A$race + 
                ...
                PFAS_A$married + PFAS_A$fish + PFAS_A$height, family = gaussian, weight = PFAS_A[[j]])
