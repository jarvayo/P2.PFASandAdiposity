...
table1(~ age_mom_enroll_d + mom_age_comp_d_ma17 + bmi_mom_prepreg_d + parity_d + 
         mom_firstperiod_12y + mom_period_ystopped_age_qu17, data = PFAS_A_NA, overall="Total")

table1(~ race2_mom_epi_epia_d + coll_grad + gt70k + smokpreg_final_d + income_hh_epq_epqa_d +
         married_cohab, data = PFAS_A_NA, overall="Total")
...
table1(~ race2_mom_epi_epia_d + coll_grad + gt70k + smokpreg_final_d + income_hh_epq_epqa_d +
         married_cohab, data = PFAS_D_NA, overall="Total")
...
PFAS_A_ARG <- aregImpute(~ mom_period_ystopped_age_qu17 + gt70k + mom_firstperiod_12y + 
                           married_cohab + coll_grad + race2_mom_epi_epia_d + smokpreg_final_d + 
                           bmi_mom_prepreg_d + parity_d + g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + 
...
PFAS_D_ARG <- aregImpute(~ mom_period_ystopped_age_qu17 + gt70k + mom_firstperiod_12y + 
                           married_cohab + coll_grad + race2_mom_epi_epia_d + smokpreg_final_d + 
                           bmi_mom_prepreg_d + parity_d + g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + 
                           PFOA + PFNA2 + PFHxS + Me_PFOSA_AcOH2 + Et_PFOSA_AcOH, 
...
table1(~ age_mom_enroll_d + mom_age_comp_d_ma17 + bmi_mom_prepreg_d + parity_d + 
         mom_firstperiod_12y + mom_period_ystopped_age_qu17, data = PFAS_A_COMP, overall="Total")

table1(~ race2_mom_epi_epia_d + coll_grad + gt70k + smokpreg_final_d + married_cohab,
       data = PFAS_A_COMP, overall="Total")

##### RE-CHECK VARIABLE DISTRIBUTION FOR DATASET WITH IMPUTED DATA 
table1(~ age_mom_enroll_d + bmi_mom_prepreg_d + parity_d + 
         mom_firstperiod_12y + mom_period_ystopped_age_qu17, data = PFAS_D_COMP, overall="Total")
