...
PFAS_X <- subset(PFAS_X, select = c(aid, age_days_comp_d_ma17, age_days_mdxa17, age_mom_enroll_d, 
                                    bmi_mom_prepreg_d, coll_grad, Et_PFOSA_AcOH, PFDeA, PFHxS, PFNA2, PFOA, 
                                    PFOS, PFOSA, Me_PFOSA_AcOH2, g_age_days_COLL_D_BLD1, gt70k, 
                                    income_hh_epq_epqa_d, married_cohab, nullip,parity_d, race2_mom_epi_epia_d))

##### SAVE DATASET
write.csv(PFAS_8, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_BF_C.csv", row.names = T)
write_sas(PFAS_8, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_BF_C.sas7bdat")

write.csv(PFAS_9, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_DXABF_C.csv", row.names = T)
write_sas(PFAS_9, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_DXABF_C.sas7bdat")

# THE "C" AT THE END OF THE SAVED FILES INDICATES THAT THE DATASET IS CLEAN
# THE "BF" INDICATES THAT NO BODY FAT MEASURES AREM MISSING
# THE "DXA" INDICATES THAT THERE ARE NO DXA MEASURES MISSING
