...
table1(~ TRUNK_FAT_mdxa17 + WBTOT_FAT_mdxa17 + TFIN + BFIN + 
         mom_weight_ma17 + mom_height_ma17 + mom_waist_ma17, 
       data = PFAS_D, overall = "Total")
...
##### OUTCOMES CORRELATION MATRIX
# DXA
OUTCOMES_D_corr <- PFAS_D[ , c("TrnkFat", "TotFat", "TFIN", "BFIN")]
...
# DXA + ANTHRO
OUTCOMES_D_corr <- PFAS_D[ , c("Weight", "Height", "Waist", "TrnkFat", "TotFat", "TFIN", "BFIN")]
o_D_corr <- cor(OUTCOMES_D_corr)
round(o_D_corr, 2)
