...
table1(~ mom_bmi_MT + mom_waist_ma17 + WHR + WHtR + mom_muac_ma17, data = PFAS_A, overall = "Total")
...
# ANTHRO
OUTCOMES_A_corr <- PFAS_A[ , c("BMI", "Waist", "WHR", "WHtR", "MUAC")]
...
table1(~ TRUNK_FAT_mdxa17 + WBTOT_FAT_mdxa17 + WBTOT_PFAT_mdxa17 + mom_bmi_MT + 
         mom_waist_ma17 + WHR + WHtR + mom_muac_ma17, data = PFAS_D, overall = "Total")
...
##### OUTCOMES CORRELATION MATRIX
# DXA
OUTCOMES_D_corr <- PFAS_D[ , c("TrnkFat", "TotFat", "TotFatPct")]
...
# DXA + ANTHRO
OUTCOMES_D_corr <- PFAS_D[ , c("BMI", "Waist", "WHR", "WHtR", "MUAC", "TrnkFat", "TotFat", "TotFatPct")]
o_D_corr <- cor(OUTCOMES_D_corr)
round(o_D_corr, 2)
