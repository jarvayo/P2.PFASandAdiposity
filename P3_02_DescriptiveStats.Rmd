...
table1(~ age_enroll + age_fu + fu_time + menar + bmi + bmi_cat + race +  income + 
         parity + smoke + married + edu + meno_cat + meno + fish + darkmeat, 
...
table1(~ age_enroll + menar + bmi + bmi_cat + race +  income + parity + smoke + 
         married + edu + meno_cat + meno + fish + darkmeat, data = PFAS_X, overall = "Total")
...
# ANTHRO
OUTCOMES_A_corr <- PFAS_A[ , c("BMI", "Weight", "DBMI", "Waist", "WHR", "WHtR", "MUAC")]
