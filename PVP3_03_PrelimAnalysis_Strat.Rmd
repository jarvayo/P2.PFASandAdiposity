...
# WEIGHT, BMI
ad.l2m.wt.bmi <- list(
  "WT" = glm(Weight ~ L2PFOS + age_enroll + race + smoke + 
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT" = glm(Weight ~ L2PFOA + age_enroll + race + smoke +
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT" = glm(Weight ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT" = glm(Weight ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT" = glm(Weight ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT, B0" = glm(Weight ~ L2PFOS + age_enroll + race + smoke + 
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B0" = glm(Weight ~ L2PFOA + age_enroll + race + smoke +
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B0" = glm(Weight ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B0" = glm(Weight ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B0" = glm(Weight ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B0" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WT, B1" = glm(Weight ~ L2PFOS + age_enroll + race + smoke + 
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WT, B1" = glm(Weight ~ L2PFOA + age_enroll + race + smoke +
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WT, B1" = glm(Weight ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WT, B1" = glm(Weight ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WT, B1" = glm(Weight ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WT, B1" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1))

modelsummary(ad.l2m.wt.bmi, fmt = 4,
             estimate = "{estimate}{stars}",
             statistic = c("SE: {std.error}"),
             coef_omit = c(-2, -15, -16, -17, -18, -19), 
...
ad.l2m.wt.meno <- list(
  ...
  "WT" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WT, M0" = glm(Weight ~ L2PFOS + age_enroll + race + smoke + 
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M0" = glm(Weight ~ L2PFOA + age_enroll + race + smoke +
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M0" = glm(Weight ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M0" = glm(Weight ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M0" = glm(Weight ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M0" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WT, M1" = glm(Weight ~ L2PFOS + age_enroll + race + smoke + 
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WT, M1" = glm(Weight ~ L2PFOA + age_enroll + race + smoke +
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WT, M1" = glm(Weight ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WT, M1" = glm(Weight ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WT, M1" = glm(Weight ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WT, M1" = glm(Weight ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1))
...
ad.l2m.waist.bmi <- list(
  "WC" = glm(Waist ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC" = glm(Waist ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC" = glm(Waist ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC" = glm(Waist ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC" = glm(Waist ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC, B0" = glm(Waist ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B0" = glm(Waist ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B0" = glm(Waist ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B0" = glm(Waist ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B0" = glm(Waist ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B0" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B0),
  "WC, B1" = glm(Waist ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WC, B1" = glm(Waist ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WC, B1" = glm(Waist ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WC, B1" = glm(Waist ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WC, B1" = glm(Waist ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1),
  "WC, B1" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_B1))
...
ad.l2m.waist.bmi <- list(
  ...
  "WC" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A),
  "WC, M0" = glm(Waist ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M0" = glm(Waist ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M0" = glm(Waist ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M0" = glm(Waist ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M0" = glm(Waist ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M0" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M0),
  "WC, M1" = glm(Waist ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WC, M1" = glm(Waist ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WC, M1" = glm(Waist ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WC, M1" = glm(Waist ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WC, M1" = glm(Waist ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1),
  "WC, M1" = glm(Waist ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_A_M1))
...
ad.l2m.trnkfat.bmi <- list(
  "TFM" = glm(TrnkFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM" = glm(TrnkFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM" = glm(TrnkFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM" = glm(TrnkFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM" = glm(TrnkFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM, B0" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B0" = glm(TrnkFat ~ L2PFOA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B0" = glm(TrnkFat ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B0" = glm(TrnkFat ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B0" = glm(TrnkFat ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B0" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TFM, B1" = glm(TrnkFat ~ L2PFOS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TFM, B1" = glm(TrnkFat ~ L2PFOA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TFM, B1" = glm(TrnkFat ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TFM, B1" = glm(TrnkFat ~ L2PFHxS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TFM, B1" = glm(TrnkFat ~ L2MeFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TFM, B1" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1))
...
ad.l2m.trnkfat.meno <- list(
  ...
  "TFM" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TFM, M0" = glm(TrnkFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M0" = glm(TrnkFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M0" = glm(TrnkFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M0" = glm(TrnkFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M0" = glm(TrnkFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M0" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TFM, M1" = glm(TrnkFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TFM, M1" = glm(TrnkFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TFM, M1" = glm(TrnkFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TFM, M1" = glm(TrnkFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TFM, M1" = glm(TrnkFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TFM, M1" = glm(TrnkFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1))
...
# TOTAL BODY FAT MASS, BMI
ad.l2m.totfat.bmi <- list(
  "TBFM" = glm(TotFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM" = glm(TotFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM" = glm(TotFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM" = glm(TotFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke + 
                  parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM" = glm(TotFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM, B0" = glm(TotFat ~ L2PFOS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B0" = glm(TotFat ~ L2PFOA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B0" = glm(TotFat ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B0" = glm(TotFat ~ L2PFHxS + age_enroll + race + smoke + 
                  parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B0" = glm(TotFat ~ L2MeFOSAA + age_enroll + race + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B0" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_B0),
  "TBFM, B1" = glm(TotFat ~ L2PFOS + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TBFM, B1" = glm(TotFat ~ L2PFOA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TBFM, B1" = glm(TotFat ~ L2PFNA + age_enroll + race + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TBFM, B1" = glm(TotFat ~ L2PFHxS + age_enroll + race + smoke + 
                  parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TBFM, B1" = glm(TotFat ~ L2MeFOSAA + age_enroll + race + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_B1),
  "TBFM, B1" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_B1))
...
ad.l2m.totfat.meno <- list(
  ...
  "TBFM" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D),
  "TBFM, M0" = glm(TotFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M0" = glm(TotFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M0" = glm(TotFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M0" = glm(TotFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke + 
                  parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M0" = glm(TotFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M0" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_M0),
  "TBFM, M1" = glm(TotFat ~ L2PFOS + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TBFM, M1" = glm(TotFat ~ L2PFOA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TBFM, M1" = glm(TotFat ~ L2PFNA + age_enroll + race + bmi_cat + smoke +  
                 parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TBFM, M1" = glm(TotFat ~ L2PFHxS + age_enroll + race + bmi_cat + smoke + 
                  parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TBFM, M1" = glm(TotFat ~ L2MeFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_M1),
  "TBFM, M1" = glm(TotFat ~ L2EtFOSAA + age_enroll + race + bmi_cat + smoke + 
                    parity + married + fish + height, family = gaussian, data = PFAS_D_M1))
