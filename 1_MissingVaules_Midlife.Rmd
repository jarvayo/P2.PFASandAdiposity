...
table1(~ age_mom_enroll_d + mom_age_days_mdxa17 + bmi_mom_prepreg_d + parity_d +
         mod_pre_d + vig_pre_d, data = PFAS_NA, overall="Total")

table1(~ race2_mom_epi_epia_d + coll_grad + smokpreg_final_d + gt70k,
         data = PFAS_NA, overall="Total")
...
table1(~ age_mom_enroll_d + mom_age_days_mdxa17 + bmi_mom_prepreg_d + parity_d +
         mod_pre_d + vig_pre_d, data = PFAS_COMP, overall="Total")

table1(~ race2_mom_epi_epia_d + coll_grad + smokpreg_final_d + gt70k, 
       data = PFAS_COMP, overall="Total")
...
```{r}
##### SAVE DATASET
write.csv(PFAS_COMP, file = "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_C_COMP.csv", row.names = T)
write_sas(PFAS_COMP, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandAdiposity/Data/PFAS_C_COMP.sas7bdat")
