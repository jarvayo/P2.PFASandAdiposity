...
table1(~ bmi_cat + race2_mom_epi_epia_d + coll_grad + smokpreg_final_d + gt70k  + income_hh_epq_epqa_d +
...
PFAS_IPW_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_ystopped_age_qu17 + married_cohab + 
                             coll_grad + race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + 
                             parity_d + age_mom_enroll_d + PFOS + PFOA + PFNA2 + PFHxS + Me_PFOSA_AcOH2 + 
                             Et_PFOSA_AcOH, nk = 0, data = PFAS_IPW_NA, n.impute = 5)
...
PFAS_A_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_ystopped_age_qu17 + married_cohab + 
                           coll_grad + race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + 
...
PFAS_D_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_ystopped_age_qu17 + married_cohab + 
                           coll_grad + race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + 
                           parity_d + g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + PFOA + PFNA2 + 
...
table1(~ age_mom_enroll_d + mom_age_comp_d_ma17 + age_days_comp_d_ma17 + 
         mom_firstperiod_12y + bmi_mom_prepreg_d, data = PFAS_A_COMP, overall="Total")
...
table1(~ age_mom_enroll_d + mom_age_mdxa17 + age_days_mdxa17 + 
         mom_firstperiod_12y + bmi_mom_prepreg_d, data = PFAS_D_COMP, overall="Total")
