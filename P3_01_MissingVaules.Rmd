...
table1(~ age_mom_enroll_d + mom_age_comp_d_ma17 + age_days_comp_d_ma17 + mom_firstperiod_12y +
         bmi_mom_prepreg_d + meno_cat + mom_period_ystopped_age_qu17, data = PFAS_A_NA, overall="Total")
...
table1(~ age_mom_enroll_d + mom_age_mdxa17 + age_days_mdxa17 + mom_firstperiod_12y +
         bmi_mom_prepreg_d + meno_cat + mom_period_ystopped_age_qu17, 
...
PFAS_IPW_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_stopped_qu17 +
                             mom_period_ystopped_age_qu17 + married_cohab + coll_grad + 
                             race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + parity_d + 
                             age_mom_enroll_d + PFOS + PFOA + PFNA2 + PFHxS + Me_PFOSA_AcOH2 + 
...
PFAS_A_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_stopped_qu17 +
                           mom_period_ystopped_age_qu17 + married_cohab + coll_grad + 
                           race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + parity_d + 
...
PFAS_D_ARG <- aregImpute(~ gt70k + mom_firstperiod_12y + mom_period_stopped_qu17 + 
                           mom_period_ystopped_age_qu17 + married_cohab + coll_grad + 
                           race2_mom_epi_epia_d + smokpreg_final_d + bmi_mom_prepreg_d + parity_d + 
                           g_age_days_COLL_D_BLD1 + age_mom_enroll_d + PFOS + PFOA + PFNA2 + 
