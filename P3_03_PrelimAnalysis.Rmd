...
table1(~ age + menar + bmi + bmi_cat + race +  income + parity + smoke +
         married + edu + fish + darkmeat + exer + exer_cat, data = PFAS_A, overall = "Total")
...
##### TABE 1
table1(~ age + menar + bmi + bmi_cat + race +  income + parity + smoke +
         married + edu + fish + darkmeat + exer + excer_cat, data = PFAS_D, overall = "Total")
...
pval_TRNK <- NULL
for (i in 2:7){
m_TRNK <- glm(PFAS_D$LNTKNFAT ~ PFAS_D[[i]] + PFAS_D$age + PFAS_D$race + 
...
pval_FAT <- NULL
for (i in 2:7){
m_FAT <- glm(PFAS_D$LNTOTFAT ~ PFAS_D[[i]] + PFAS_D$age + PFAS_D$race + 
                PFAS_D$income + PFAS_D$menar + PFAS_D$smoke +  PFAS_D$parity + 
                PFAS_D$married, family = gaussian)
