...
pval_a <- c( 0.0007957443, 0.006, 0.550, 0.930, 0.435, 0.0009692368,
...
##### EMPLOY FDR CORRECTION
# CREATE NUMERIC VECTOR OF P-VALUES
pval_ad <- c(  0.0007957443, 0.006, 0.550, 0.930, 0.435, 0.0009692368,
             0.034, 0.022, 0.049, 0.481, 0.824, 0.004,
             0.7, 0.07, 0.028, 0.72, 0.87, 0.10,
             0.005, 0.011, 0.331, 0.475, 0.264, 0.001,
...
rownames(pval_BMI)[i-43] <- paste("X", i-43, sep="")
}
...
rownames(pval_Waist)[i-43] <- paste("X", i-43, sep="")
}
...
rownames(pval_WHR)[i-43] <- paste("X", i-43, sep="")
}
...
rownames(pval_WHtR)[i-43] <- paste("X", i-43, sep="")
}
...
rownames(pval_MUAC)[i-43] <- paste("X", i-43, sep="")
}
...
rownames(pval_TRNK)[i-55] <- paste("X", i-55, sep="")
}
...
rownames(pval_FAT)[i-55] <- paste("X", i-55, sep="")
}
...
rownames(pval_PFAT)[i-55] <- paste("X", i-55, sep="")
}
