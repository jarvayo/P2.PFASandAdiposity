...
PFAS_3 <- subset(PFAS_2, !is.na(mom_bodyfat_ma17)) # MISSING TOTAL BODY FAT %
PFAS_4 <- subset(PFAS_3, !is.na(PFOS)) # MISSING PFASBP DATA
PFAS_5 <- subset(PFAS_4, g_age_days_COLL_D_BLD1 <= 154) # MISSING 1ST OR 2ND TRIMESTER PFAS DATA (I.E., 22 WEEKS GESTATION)
