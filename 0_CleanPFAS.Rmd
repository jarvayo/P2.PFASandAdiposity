...
PFAS_1 <- subset(PFAS, !is.na(VAT_AREA_mdxa17)) # MISSING DXA MEASURES
PFAS_2 <- subset(PFAS_1, !is.na(mom_waist_ma17)) # MISSING WAIST CIRCUMFERENCE
PFAS_3 <- subset(PFAS_2, !is.na(PFOS)) # MISSING PFASBP DATA
PFAS_4 <- subset(PFAS_3, g_age_days_COLL_D_BLD1 <= 154) # MISSING 1ST OR 2ND TRIMESTER PFAS DATA (I.E., 22 WEEKS GESTATION)
...
table(PFAS_4$t1diab_mom_epi_epia_d)
table(PFAS_4$t2diab_mom_epi_epia_d)
PFAS_5 <- subset(PFAS_4, t1diab_mom_epi_epia_d != 1 & t2diab_mom_epi_epia_d != 1) # HISTORY OF DIABETES
...
##### SAVE DATASET
write.csv(PFAS_5, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandMidlife/Data/PFAS_C.csv", row.names = T)
write_sas(PFAS_5, "C:/Users/jarva/Desktop/James-Todd Lab/PFASandMidlife/Data/PFAS_C.sas7bdat")
