...
# PFOS
a_d_PFOS <- glm(a.cens ~ L2PFOS + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
a_pd_PFOS <- 1-predict(a_d_PFOS, type = "response")

# PFOA
a_d_PFOA <- glm(a.cens ~ L2PFOA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
a_pd_PFOA <- 1-predict(a_d_PFOA, type = "response")

# PFNA
a_d_PFNA <- glm(a.cens ~ L2PFNA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
a_pd_PFNA <- 1-predict(a_d_PFNA, type = "response")

# PFHxS
a_d_PFHxS <- glm(a.cens ~ L2PFHxS + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
a_pd_PFHxS <- 1-predict(a_d_PFHxS, type = "response")

# MeFOSAA
a_d_MeFOSAA <- glm(a.cens ~ L2MeFOSAA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
a_pd_MeFOSAA <- 1-predict(a_d_MeFOSAA, type = "response")

# EtFOSAA
a_d_EtFOSAA <- glm(a.cens ~ L2EtFOSAA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW1)
...
# PFOS
d_d_PFOS <- glm(d.cens ~ L2PFOS + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
d_pd_PFOS <- 1-predict(d_d_PFOS, type = "response")

# PFOA
d_d_PFOA <- glm(d.cens ~ L2PFOA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
d_pd_PFOA <- 1-predict(d_d_PFOA, type = "response")

# PFNA
d_d_PFNA <- glm(d.cens ~ L2PFNA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
d_pd_PFNA <- 1-predict(d_d_PFNA, type = "response")

# PFHxS
d_d_PFHxS <- glm(d.cens ~ L2PFHxS + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
d_pd_PFHxS <- 1-predict(d_d_PFHxS, type = "response")

# MeFOSAA
d_d_MeFOSAA <- glm(d.cens ~ L2MeFOSAA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
d_pd_MeFOSAA <- 1-predict(d_d_MeFOSAA, type = "response")

# EtFOSAA
d_d_EtFOSAA <- glm(d.cens ~ L2EtFOSAA + age_enroll + race + income + menar + smoke +  
                 parity + married, family = binomial(), data = PFAS_IPW2)
